# -*- coding: utf-8 -*-
"""Fake News Detector & News Generator Web App (app.py)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17aX3IS4BASRYVrx6Ve3qyya_FsvXU5Lv
"""
...
def download_nltk_data():
    ...
    for package in nltk_packages:
        try:
            ...
            st.warning(f"Downloading NLTK package: {package}...")
            nltk.download(package, quiet=True)
            st.success(f"NLTK package '{package}' downloaded!")
    st.success("All NLTK data checked/downloaded successfully!")

# Call the download function at the beginning of the script execution
download_nltk_data()
...
st.title("🕵️ Fake News Detector & News Generator ✍️") # Changed title and added emoji
st.markdown("""
    <style>
    .stApp {
    ...
    .stTextArea textarea {
        background-color: #1a1c20; /* Darker text area */
        color: #e0e0e0;
        border-radius: 8px;
    ...
    .stSlider .stSliderHandle {
        background-color: #4CAF50; /* Green slider handle */
    }
    ...
    .stAlert.success {
        background-color: #52c41a; /* Green for success */
        color: white;
    }
    .stAlert.warning {
        background-color: #faad14; /* Orange for warning */
        color: white;
    }
    a {
...
st.header("✍️ News Generator") # Renamed from Text Generator
...
st.markdown("---")
st.caption("Project by Harshit Dubey") # Removed "Guided by Gaurav Singh"
...
col1, col2, col3 = st.columns([1,1,1]) # Use columns for horizontal layout
