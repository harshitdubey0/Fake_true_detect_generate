...
# --- FINAL NLTK FIX: Explicitly set NLTK data path at runtime ---
# This path must match where NLTK data is downloaded in the Dockerfile.
# The Dockerfile (v8) downloads to /home/appuser/nltk_data
NLTK_DATA_DIR = "/home/appuser/nltk_data"
if NLTK_DATA_DIR not in nltk.data.path:
    nltk.data.path.insert(0, NLTK_DATA_DIR)
    os.environ["NLTK_DATA"] = NLTK_DATA_DIR # Ensure env var is also set
...
def load_generator_pipeline():
    ...
    try:
        # Determine device: Streamlit Cloud free tier is CPU only.
        # Explicitly set device to 'cpu' to avoid issues if torch.cuda.is_available()
        # returns True but no actual GPU is configured for the app.
        ...
        generator_pipeline = pipeline(
            ...
            model='gpt2',
            tokenizer='gpt2',
            device=0 if torch.cuda.is_available() else -1 # This line will now evaluate to -1 (CPU)
        )
