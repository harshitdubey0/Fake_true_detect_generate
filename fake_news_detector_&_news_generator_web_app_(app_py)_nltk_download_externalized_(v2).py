# -*- coding: utf-8 -*-
"""Fake News Detector & News Generator Web App (app.py) - NLTK Download Externalized (v2)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KbekG7vCz5Qa-0jyRPAjEO7ncM-aBren
"""
...
# --- NLTK Data Download (REMOVED FROM HERE - WILL BE HANDLED EXTERNALLY VIA DOCKERFILE) ---
# The download_nltk_data_robust function and its call are removed from this app.py.
# NLTK data will be downloaded during the Docker build process.

# --- Text Preprocessing Function (Cached for efficiency) ---
@st.cache_data
def preprocess_text(text):
    """Cleans and preprocesses text for the detector."""
    # These should be initialized AFTER NLTK data is guaranteed to be downloaded
    # (which will now happen during the Docker build)
